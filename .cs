...
namespace ModStudioLogic.Tests.Mods
{
    public class ModFeatureTests
    {
        [Fact]
        public void ModFeature_DefaultFolderName_ReturnsNAN()
        {
            // Arrange
            ModFeature modFeature = new ModFeature();
